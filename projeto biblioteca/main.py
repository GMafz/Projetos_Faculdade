...
#
# # Codificar username e senha usando quote_plus
# encoded_username = quote_plus(username)
# encoded_password = quote_plus(password)
#
# # Construir a URI corretamente
...
#     genero = input("Digite o gênero do livro: ")  # Adicionado
#     ano_publicacao = input("Digite o ano de publicação: ")  # Adicionado
#     quantidade_exemplares = int(input("Digite a quantidade de exemplares disponíveis: "))  # Adicionado
#
#     livro = {
#         "_id": isbn,
#         "titulo": titulo,
#         "autor": autor,
#         "genero": genero,  # Adicionado
#         "ano": int(ano_publicacao),  # Convertendo para inteiro
#         "quantidade_disponiveis": quantidade_exemplares,  # Adicionado
#         "disponivel": quantidade_exemplares > 0  # Define se o livro está disponível
#     }
#     livros_collection.insert_one(livro)
#     print(f"Livro '{titulo}' adicionado com sucesso.")
#
# # Adicionando o cadastro de usuários com os campos solicitados
# def adicionar_usuario():
#     user_id = input("Digite o ID do usuário: ")
#     nome = input("Digite o nome do usuário: ")
#     email = input("Digite o e-mail do usuário: ")
#     data_nascimento = input("Digite a data de nascimento (DD/MM/AAAA): ")  # Adicionado
#     numero_documento = input("Digite o número do documento (CPF ou RG): ")  # Adicionado
#
#     usuario = {
#         "_id": user_id,
#         "nome": nome,
...
#         "numero_documento": numero_documento  # Adicionado
#     }
...
#     if not livro or livro['quantidade_disponiveis'] <= 0:  # Alterado para verificar a quantidade
...
#
# # Atualizando o retorno de devolução
...
#     emprestimos_collection.update_one({"_id": emprestimo["_id"]},
#                                        {"$set": {"data_devolucao": datetime.now().strftime("%Y-%m-%d")}})
#
#     # Atualiza a quantidade de exemplares disponíveis do livro
#     livro = livros_collection.find_one({"_id": livro_id})
#     if livro:
...
#     livros = list(livros_collection.find({"quantidade_disponiveis": {"$gt": 0}}))
#     if livros:
#         tabela = [
#             [
#                 livro['_id'],
#                 livro['titulo'],
#                 livro['autor'],
#                 livro['genero'],  # Adicionado
#                 livro['ano'],
#                 livro['quantidade_disponiveis'],  # Adicionado
#                 "Sim" if livro['disponivel'] else "Não"
#             ]
#             for livro in livros
#         ]
#         print(tabulate(tabela, headers=["ISBN", "Título", "Autor", "Gênero", "Ano", "Exemplares Disponíveis", "Disponível"], tablefmt="pretty"))
#     else:
#         print("Nenhum livro disponível encontrado.")
#
# def consultar_emprestimos_usuario():
#     usuario_id = input("Digite o ID do usuário para consultar empréstimos: ")
...
#                 emprestimo['data_devolucao'] or "Em andamento"
#             ]
#             for emprestimo in emprestimos
#         ]
#         print(tabulate(tabela, headers=["ID Livro", "Data Empréstimo", "Data Devolução"], tablefmt="pretty"))
#     else:
#         print(f"Nenhum empréstimo em aberto encontrado para o usuário {usuario_id}.")
#
# def consultar_usuarios_vencidos():
#     data_atual = datetime.now()
#     emprestimos_vencidos = list(emprestimos_collection.find({"data_devolucao": None, "data_emprestimo": {"$lt": data_atual.strftime("%Y-%m-%d")}}))
...
#         ]
#         print(tabulate(tabela, headers=["ID Usuário", "ID Livro", "Data Empréstimo"], tablefmt="pretty"))
#     else:
...
#     if livros:
#         tabela = [
#             [livro['_id'], livro['titulo'], livro['autor'], livro['genero'], livro['ano'], livro['quantidade_disponiveis']]
#             for livro in livros
#         ]
...
#         print(tabulate(tabela, headers=["ID Usuário", "Nome", "Email", "Data Nascimento", "Número Documento"], tablefmt="pretty"))
#     else:
...
#     if emprestimos:
#         tabela = [
#             [emprestimo['livro_id'], emprestimo['usuario_id'], emprestimo['data_emprestimo'], emprestimo['data_devolucao'] or "Em andamento"]
#             for emprestimo in emprestimos
#         ]
...
#         print("6. Consultar Empréstimos de Usuário")
#         print("7. Consultar Usuários com Empréstimos Vencidos")
#         print("8. Relatório de Livros")
#         print("9. Relatório de Usuários")
#         print("10. Relatório de Empréstimos")
#         print("0. Sair")
